...
class diccionario
{
    ...
    ~diccionario();
    friend ostream& operator<<(ostream& f,const diccionario& d);
    ...
    bool contieneclave_aux( const NodoABBD* raiz,clave k)const;
    valor buscarvalor_aux(const NodoABBD* raiz,clave k)const;
    ...
    NodoABBD* intersecarcon_aux(NodoABBD* raiz, const NodoABBD* raiz2);
    void claves_aux(NodoABBD* raiz,listaInt& _claves)const;
    void valores_aux(NodoABBD* raiz,listaInt& _valores)const;
