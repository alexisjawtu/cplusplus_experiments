...
int main()
{
    ...
    while (opcion!=4)
    {
        cout<<"elija opción: "<<endl<<"1- Agregar registro de precipitaciones"<<endl<<"2- Borrar registro de precipitaciones"<<endl<<"3- Elegir registro de precipitaciones"<<endl<<"4- Salir";
        cin>>opcion;
        if (opcion == 1)
        {
            ...
            while(continuar==1)
                {
                    ...
                    cout<<"si desea borrar mas registros presione 1, sino presione 2"<<endl;
                    cin>>continuar;
                }
        }
        if(opcion == 3)
